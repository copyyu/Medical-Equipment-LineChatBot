	...
	return map[string]interface{}{
		...
		"body": map[string]interface{}{
			...
			"contents": []interface{}{
				...
				map[string]interface{}{"type": "button", "style": "primary", "color": "#5B9BD5", "margin": "md", "action": map[string]interface{}{"type": "postback", "label": "แจ้งปัญหา / เช็กสถานะ", "data": "action=report_problem"}},
				map[string]interface{}{"type": "button", "style": "primary", "color": "#FF9800", "margin": "sm", "action": map[string]interface{}{"type": "postback", "label": "🔄 แจ้งเปลี่ยนเครื่อง", "data": "action=request_change"}},
				map[string]interface{}{"type": "button", "style": "primary", "color": "#4CAF50", "margin": "sm", "action": map[string]interface{}{"type": "postback", "label": "ติดตามสถานะ", "data": "action=track_status"}},
				map[string]interface{}{"type": "button", "style": "secondary", "margin": "sm", "action": map[string]interface{}{"type": "postback", "label": "ติดต่อเจ้าหน้าที่", "data": "action=contact_staff"}},
			},
		},
	...
	return map[string]interface{}{
		...
		"footer": map[string]interface{}{
			...
			"contents": []interface{}{
				...
				map[string]interface{}{"type": "button", "style": "secondary", "height": "sm", "action": map[string]interface{}{"type": "postback", "label": "↩️ กลับเมนูหลัก", "data": "action=main_menu"}},
			},
		},
	}
}
