...
const (
	...
	MsgPleaseSelectReport = "ขออภัยค่ะ กรุณากดเมนู \"แจ้งปัญหา / เช็คสถานะ\" ก่อนส่งรูปค่ะ 🙇🏻‍♀️"
...
// แจ้งปัญหา
const (
	MsgInputIssueDesc     = "✏️ กรุณาพิมพ์รายละเอียดปัญหาที่พบค่ะ\n\nตัวอย่าง: เครื่องเปิดไม่ติด, หน้าจอไม่แสดงผล"
	MsgIssueReportSuccess = "✅ บันทึกการแจ้งปัญหาเรียบร้อยแล้วค่ะ"
	MsgIssueReportFailed  = "❌ ไม่สามารถบันทึกการแจ้งปัญหาได้"
)

// ดูเครื่องใกล้หมดอายุ - เลือกแผนก
const (
	MsgDeptNotFound = "❌ ไม่พบแผนกที่ค้นหาค่ะ กรุณาลองพิมพ์ใหม่ หรือกดเลือกจากรายการด้านบนค่ะ"
)
