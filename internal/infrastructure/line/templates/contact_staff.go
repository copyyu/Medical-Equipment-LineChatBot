		...
		"body": map[string]interface{}{
			...
			"contents": []interface{}{
				...
				map[string]interface{}{"type": "box", "layout": "vertical", "margin": "md", "contents": []interface{}{
					map[string]interface{}{"type": "text", "text": "โทร: 0123456789", "size": "sm"},
					map[string]interface{}{"type": "text", "text": "Email: example@hospital.com", "size": "sm"},
				...
				map[string]interface{}{"type": "box", "layout": "vertical", "margin": "md", "backgroundColor": "#FFEBEE", "cornerRadius": "md", "paddingAll": "10px", "contents": []interface{}{
					...
					map[string]interface{}{"type": "text", "text": "โทร: 9876543210 (24 ชม.)", "color": "#C62828", "size": "sm"},
				}},
			},
		},
	}
